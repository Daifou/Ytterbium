...
export const Header: React.FC<HeaderProps> = ({ onGetStartedClick, onLoginClick, isDashboard = false, currentUser }) => {
    ...
    return (
        <motion.header
            ...
            className="fixed top-0 left-0 right-0 z-[200] border-b border-zinc-800 bg-zinc-950/70 backdrop-blur-md h-14"
        >
                        ...
                        <>
                            ...
                            <div className="pl-4 md:px-10 h-full flex items-center">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="bg-white text-zinc-950 px-5 py-1.5 rounded-xl font-medium text-sm hover:bg-zinc-100 transition-all duration-200"
                                >
                                    Get started
                                </motion.button>
                            </div>
