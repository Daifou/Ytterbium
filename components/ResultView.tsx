    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-5xl h-auto md:h-[500px] flex flex-col md:flex-row bg-[#09090b] border border-white/10 rounded-2xl shadow-2xl overflow-hidden relative md:translate-y-8"
            >
