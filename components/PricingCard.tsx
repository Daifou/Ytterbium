...
export const PricingCard: React.FC<PricingCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className="relative group rounded-[32px] bg-[#050505] border border-white/10 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)] overflow-hidden grid md:grid-cols-2 gap-0 md:divide-x divide-white/5 transition-all duration-700 hover:border-white/20">
                ...
                {/* RIGHT PANEL: The "Value" - Warm, Clean, Human */}
